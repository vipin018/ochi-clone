		...
		<div className="w-full h-screen bg-[#f1f1f1] p-20 flex gap-5  rounded-xl">
			<div className="w-1/2 flex flex-col justify-between h-full ">
				<div className="heading">
					{["Eye-", "Opening"].map((item, index) => {
						return (
							<h1 className="text-[10vw] uppercase leading-[12vw] -mb-10 tracking-tighter font-['Anton] font-bold	">
								{item}
							</h1>
						);
					})}
			...
			<div className="w-1/2 ">
				<motion.h1
					...
					className="text-[9vw] uppercase leading-none -mb-10 tracking-tighter font-anton font-thin"
				>
					Presentations
				</motion.h1>
